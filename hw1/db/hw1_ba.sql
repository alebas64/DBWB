...
--
-- Host: 127.0.0.1
-- Creato il: Mag 29, 2022 alle 11:09
...
CREATE TABLE `comments` (
  `id` int(11) NOT NULL,
  `cod_creatore` varchar(20) NOT NULL,
...
CREATE TABLE `user` (
  ...
  `hash_pasw` varchar(255) NOT NULL,
...
ALTER TABLE `user`
  ...
  ADD UNIQUE KEY `UC_user` (`nickname`),
  ADD UNIQUE KEY `UC_email` (`email`),
  ADD KEY `i_user` (`nickname`),
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`cod_creatore`) REFERENCES `user` (`nickname`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `likes_comments`
  ADD CONSTRAINT `likes_comments_ibfk_1` FOREIGN KEY (`cod_utente`) REFERENCES `user` (`nickname`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `likes_posts`
  ADD CONSTRAINT `likes_posts_ibfk_1` FOREIGN KEY (`cod_utente`) REFERENCES `user` (`nickname`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `post`
  ADD CONSTRAINT `post_ibfk_1` FOREIGN KEY (`cod_creatore`) REFERENCES `user` (`nickname`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
