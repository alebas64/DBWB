...
function verifyEmail(){
    const campo = document.querySelector('.email input');
...
document.querySelector('.passwordC input').addEventListener('blur', verifyPasswordC);
document.querySelector('.date input').addEventListener('blur',verifyDate);
